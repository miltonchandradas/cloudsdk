...
> implements EntityApi<BusinessPartner<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      TO_BP_RELATIONSHIP: new Link('to_BPRelationship', this, linkedApis[4]),
      TO_BU_PA_IDENTIFICATION: new Link(
        'to_BuPaIdentification',
        this,
        linkedApis[5]
      ),
      TO_BU_PA_INDUSTRY: new Link('to_BuPaIndustry', this, linkedApis[6]),
      ...
      TO_CUSTOMER: new OneToOneLink('to_Customer', this, linkedApis[15]),
      TO_PAYMENT_CARD: new Link('to_PaymentCard', this, linkedApis[16]),
      TO_SUPPLIER: new OneToOneLink('to_Supplier', this, linkedApis[17])
    };
    return this;
  }
